...
# Check for an existing version of the model and download it if it is missing
if not model_exists(app_dir):
    ...
    try:
        ...
        print("Error loading model as AutoModelForCausalLM. Trying with AutoModel.")
        model = AutoModel.from_pretrained("OpenAssistant/oasst-sft-6-llama-30b-xor")
...
while True:
    ...
    output_ids = quantized_model.generate(input_ids, attention_mask=attention_mask, max_length=100,
